...
export default function HeroSlideshow({
  ...
  if (slides.length === 0) {
    return (
      <section className="relative h-[600px] bg-muted flex items-center justify-center transition-colors duration-300">
        <p className="text-muted-foreground">Đang tải slideshow...</p>
      </section>
    );
  }
